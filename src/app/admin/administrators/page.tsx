 ...
 * Prisma üzerinden verileri çeker ve tablo formatında UI render eder.
 */
export default async function AdministratorsPage() {
  // Veritabanından rolü 'ADMIN' olan kullanıcıları en yeniye göre getirir
            ...
            {admins.map((user) => (
              <tr key={user.id} className="hover:bg-purple-50/30">
                <td className="p-4 flex items-center gap-3">
                  {/* Profil resmi yoksa UI-Avatars API üzerinden placeholder oluşturur */}
                  <Image
                    src={
                      user.image ||
